    ...
    <div className="flex flex-col">
      ...
      <div className="py-10 mx-[10%]">
        <div className="flex flex-col space-y-5 text-sm">
          <p>
            Do skupiny motorových vozidiel <span className="font-bold">A</span>{" "}
            patria:
          </p>
          <p>
            a)
            <span className="font-bold">
              ...
              postranným vozíkom vybavené motorom
            </span>
          ...
          <p>
            b) <span className="font-bold">motorové trojkolky</span> podľa ods.3
            b) s výkonom presahujúcim 15 kW.
          </p>
          <p>
